...
var FACTORY_ADDRESS = '0x5A95F1c1f2C5258FaEe2b59a0d3CEE9554977A05';
var INIT_CODE_HASH = '0xadefdccdecd2b095b53fd5f5255246d4d040be085bc94541902802784b3e79ee';
...
Currency.BINANCE = /*#__PURE__*/new Currency(18, 'BNB', 'Binance');
...
var CurrencyAmount = /*#__PURE__*/function (_Fraction) {
  ...
  CurrencyAmount.binance = function binance(amount) {
...
var Price = /*#__PURE__*/function (_Fraction) {
  ...
  _proto.quote = function quote(currencyAmount) {
    ...
    return CurrencyAmount.binance(_Fraction.prototype.multiply.call(this, currencyAmount.raw).quotient);
  };
...
var Pair = /*#__PURE__*/function () {
  function Pair(tokenAmountA, tokenAmountB) {
    ...
    this.liquidityToken = new Token(tokenAmounts[0].token.chainId, Pair.getAddress(tokenAmounts[0].token, tokenAmounts[1].token), 18, 'PGS', 'Pegaswap');
...
var Fetcher = /*#__PURE__*/function () {
  ...
  Fetcher.fetchPairData = function fetchPairData(tokenA, tokenB, provider) {
    try {
      ...
      return Promise.resolve(new Contract(address, IPegaswapPair.abi, provider).getReserves()).then(function (_ref) {
...
var Route = /*#__PURE__*/function () {
  function Route(pairs, input, output) {
    ...
    !(input instanceof Token && pairs[0].involvesToken(input) || input === BINANCE && pairs[0].involvesToken(WBNB[pairs[0].chainId])) ? process.env.NODE_ENV !== "production" ? invariant(false, 'INPUT') : invariant(false) : void 0;
    !(typeof output === 'undefined' || output instanceof Token && pairs[pairs.length - 1].involvesToken(output) || output === BINANCE && pairs[pairs.length - 1].involvesToken(WBNB[pairs[0].chainId])) ? process.env.NODE_ENV !== "production" ? invariant(false, 'OUTPUT') : invariant(false) : void 0;
...
var Trade = /*#__PURE__*/function () {
  function Trade(route, amount, tradeType) {
    ...
    this.inputAmount = tradeType === TradeType.EXACT_INPUT ? amount : route.input === BINANCE ? CurrencyAmount.binance(amounts[0].raw) : amounts[0];
    this.outputAmount = tradeType === TradeType.EXACT_OUTPUT ? amount : route.output === BINANCE ? CurrencyAmount.binance(amounts[amounts.length - 1].raw) : amounts[amounts.length - 1];
  ...
  _proto.minimumAmountOut = function minimumAmountOut(slippageTolerance) {
    ...
    if (this.tradeType === TradeType.EXACT_OUTPUT) {
      ...
      return this.outputAmount instanceof TokenAmount ? new TokenAmount(this.outputAmount.token, slippageAdjustedAmountOut) : CurrencyAmount.binance(slippageAdjustedAmountOut);
    }
  };
  ...
  _proto.maximumAmountIn = function maximumAmountIn(slippageTolerance) {
    ...
    if (this.tradeType === TradeType.EXACT_INPUT) {
      ...
      return this.inputAmount instanceof TokenAmount ? new TokenAmount(this.inputAmount.token, slippageAdjustedAmountIn) : CurrencyAmount.binance(slippageAdjustedAmountIn);
    }
  };
...
var Router = /*#__PURE__*/function () {
  ...
  Router.swapCallParameters = function swapCallParameters(trade, options) {
    var binanceIn = trade.inputAmount.currency === BINANCE;
    var binanceOut = trade.outputAmount.currency === BINANCE; // the router does not support both binance in and out

    !!(binanceIn && binanceOut) ? process.env.NODE_ENV !== "production" ? invariant(false, 'BINANCE_IN_OUT') : invariant(false) : void 0;
...
export { BINANCE, ChainId, Currency, CurrencyAmount, FACTORY_ADDRESS, Fetcher, Fraction, INIT_CODE_HASH, InsufficientInputAmountError, InsufficientReservesError, MINIMUM_LIQUIDITY, Pair, Percent, Price, Rounding, Route, Router, Token, TokenAmount, Trade, TradeType, WBNB, currencyEquals, inputOutputComparator, tradeComparator };
//# sourceMappingURL=pegaswap-sdk.esm.js.map
